...
def genMonstername():
    ...
    list2 = ["Rabbit", "Troll", "Dragon", "Camel", "Llama", "Ogre", "Slime Mold", "Fungal Beast", "Vampire", "Dampyr", "Malformed animal", "Shark Rocket", "Tengu", "Zombie", "Shadow", "Dragon", "Gaslich", "Hollowlich", "Embermask", "Bowelwraith", "Biters", "Cold Bodies"]
    list3 = ['Frankfurter Ave.', 'the Passyunk Warrior Clan', 'the Philly Cheesesteak Factory',
               'Manayunk Railroad Yard','Skidoo Water Park Palace', 'Dunks Ferry Playground', "Therazane","Apiarian Phantom"]
    list3 = ['Frankfurter Ave.', 'the Passyunk Warrior Clan', 'the Philly Cheesesteak Factory',
