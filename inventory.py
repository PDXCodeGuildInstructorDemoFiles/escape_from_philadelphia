...
class Inventory:                                                                                                        #create inv class                                                                                             #things on the gound
    ...
    def add_item(self, item):                                                                                                     #picking up/adding an item.
        ...
        #     print("You pick up the {}.").format(self.local_item)                                                      #all for shit
        # elif up_item == "N":
        #     print("You leave the {} where it lies.").format(self.local_item)
         self.inventory[1] = item                #no earthly idea what this means                                       #may need to create method for trade/purchase
